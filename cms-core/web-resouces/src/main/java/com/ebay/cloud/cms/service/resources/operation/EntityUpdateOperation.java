...
public class EntityUpdateOperation extends EntityOperation {
    ...
    public EntityUpdateOperation(CMSServer server, String mode, HttpServletRequest request, String priority,
    ...
    protected void performAction(EntityContext context, IEntity entity, IEntity queryEntity) {
        ...
        cmsServer.modify(priority, queryEntity, entity, context);
    }
