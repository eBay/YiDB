...
public class ServiceUnavailableException extends WebApplicationException {
    ...
    public ServiceUnavailableException() {
        super(createResponse(null, "Service currently unavailable"));
    }
    ...
    public ServiceUnavailableException(Throwable cause, String msg) {
            super(cause, createResponse(cause, msg));
    }

    private static Response createResponse(Throwable cause, String msg) {
            CMSResponse jr = new CMSResponse("503", msg, cause);
            return Response.status(503).entity(jr).type(MediaType.APPLICATION_JSON).build();
    }
}
