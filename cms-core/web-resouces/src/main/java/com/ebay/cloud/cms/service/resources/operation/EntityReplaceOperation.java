...
public class EntityReplaceOperation extends EntityOperation {
    ...
    public EntityReplaceOperation(CMSServer server, String mode, HttpServletRequest request, String priority,
    ...
    protected void performAction(EntityContext context, IEntity entity, IEntity queryEntity) {
        cmsServer.replace(priority, queryEntity, entity, context);
    }
}
