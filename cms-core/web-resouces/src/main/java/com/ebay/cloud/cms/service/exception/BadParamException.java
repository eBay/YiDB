...
public class BadParamException extends WebApplicationException {
    ...
    public BadParamException(Throwable cause, String msg) {
        super(cause, createResponse(cause, msg));
    }

    private static Response createResponse(Throwable cause, String msg) {
        CMSResponse jr = new CMSResponse("400", msg, cause);
        return Response.status(400).entity(jr).type(MediaType.APPLICATION_JSON).build();
    }
}
