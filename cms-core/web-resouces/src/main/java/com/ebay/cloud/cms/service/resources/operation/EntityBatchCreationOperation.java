...
public class EntityBatchCreationOperation extends EntityBatchOperation {

    private List<String> entityIds;

    public EntityBatchCreationOperation(CMSServer server, String mode, String failReturnOptionVal, HttpServletRequest request, String priority,
    ...
    protected void performBatchAction(EntityContext context, List<IEntity> entities, List<String> parseFails) {
        entityIds = cmsServer.batchCreate(priority, entities, context, parseFails);
    }
