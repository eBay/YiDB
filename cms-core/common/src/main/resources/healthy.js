var load = 0.2;
if ( ($latencyWrite_1m_p50 > 350) && ($writeqps_1m_max > 700) ) {
	load = 0.9;
}
if ( ($latencyRead_1m_p50 > 350) && ($readqps_1m_max > 700) ) {
	load = 0.9;
}

if ( ($latencyWrite_1m_p50 > 500) && ($writeqps_1m_max > 1000) ) {
	load = 0.95;
}

if ( ($latencyRead_1m_p50 > 500) && ($readqps_1m_max > 1000) ) {
	load = 0.95;
}
