...
@Ignore
public class ExpiredLRUCacheTest {
    String c[];
...
//        ExpiredLRUCache<String> cache = new ExpiredLRUCache<String>(100, 60);
//        
//        for (String i : c) {
//            cache.putObject(i, i);
//        }
...
//        ExpiredLRUCache<String> cache = new ExpiredLRUCache<String>(100, 1);
...
//        ExpiredLRUCache<String> cache = new ExpiredLRUCache<String>(1, 60);
//        cache.putObject(c[0], c[0]);
