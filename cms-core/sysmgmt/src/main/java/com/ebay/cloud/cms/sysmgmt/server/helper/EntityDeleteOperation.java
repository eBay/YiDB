...
public class EntityDeleteOperation extends EntityOperation {
    ...
    public EntityDeleteOperation(CMSPriority priority, IEntityService entityService, IEntity queryEntity,
    ...
    protected void performFinallyAction(boolean isSuccess) {
        doFinalAction(queryEntity, context, reqId, current, isSuccess, "DELETE", null, false);
    }
