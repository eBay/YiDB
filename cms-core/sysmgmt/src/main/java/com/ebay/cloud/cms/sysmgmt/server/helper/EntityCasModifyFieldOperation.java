...
public class EntityCasModifyFieldOperation extends EntityOperation {
    private Object oldValue;
    
    public EntityCasModifyFieldOperation(CMSPriority priority, IEntityService entityService, IEntity queryEntity,
            IEntity entity, String fieldName, EntityContext context, Object oldValue, CMSState cmsState, String reqId, MonitorStatisticsManager monitor) {
    ...
    protected String performAction() {
        ...
        entityService.casModifyField(queryEntity, entity, fieldName, oldValue, context);
        return null;
    }
    
    @Override
    protected void performFinallyAction(boolean isSuccess) {
        doFinalAction(queryEntity, context, reqId, current, isSuccess, "POST", "cas", false);
    }
}
