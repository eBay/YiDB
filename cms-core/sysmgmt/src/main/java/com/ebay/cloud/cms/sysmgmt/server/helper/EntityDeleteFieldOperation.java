...
public class EntityDeleteFieldOperation extends EntityOperation {

    public EntityDeleteFieldOperation(CMSPriority priority, IEntityService entityService, IEntity queryEntity,
    ...
    protected String performAction() {
        entityService.deleteField(queryEntity, fieldName, context);
        return null;
    }
    
    @Override
    protected void performFinallyAction(boolean isSuccess) {
        doFinalAction(queryEntity, context, reqId, current, isSuccess, "DELETE", isSuccess, false);
    }
