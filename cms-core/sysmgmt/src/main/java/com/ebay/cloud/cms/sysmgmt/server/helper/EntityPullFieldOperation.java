...
public class EntityPullFieldOperation extends EntityOperation {

    public EntityPullFieldOperation(CMSPriority priority, IEntityService entityService, IEntity queryEntity,
    ...
    protected String performAction() {
        entityService.pullField(queryEntity, entity, fieldName, context);
        return null;
    }
    
    @Override
    protected void performFinallyAction(boolean isSuccess) {
        doFinalAction(entity, context, reqId, current, isSuccess, "DELETE", entity, false);
    }
