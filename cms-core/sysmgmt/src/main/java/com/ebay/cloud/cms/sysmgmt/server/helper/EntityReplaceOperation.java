...
public class EntityReplaceOperation extends EntityOperation {
    
    public EntityReplaceOperation(CMSPriority priority, IEntityService entityService, IEntity queryEntity,
    ...
    protected String performAction() {
        entityService.replace(queryEntity, entity, context);
        return null;
    }
    
    @Override
    protected void performFinallyAction(boolean isSuccess) {
        doFinalAction(entity, context, reqId, current, isSuccess, "PUT", entity, false);
    }
}
