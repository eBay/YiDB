...
public class EntityModifyFieldOperation extends EntityOperation {
    
    public EntityModifyFieldOperation(CMSPriority priority, IEntityService entityService, IEntity queryEntity,
    ...
    protected String performAction() {
        entityService.modifyField(queryEntity, entity, fieldName, context);
        return null;
    }
