...
public class EntityExpressionTest extends CMSMongoTest {
    ...
    public void createWithExpression() {
        NewBsonEntity entity = newExpressEntity(applicationMetadata, "expression-create");

        String createId = persistenceService.create(entity, context);
        
        NewBsonEntity queryEntity = buildQueryEntity(BRANCH_TEST, RaptorEntityGenerator.TypeEnum.ApplicationService.name(), createId);
        IEntity getApp = persistenceService.get(queryEntity, context);
    ...
    public void moidfyWithExpression() {
        ...
        NewBsonEntity entity = newExpressEntity(applicationMetadata, oldName);
        ...
        getApp = persistenceService.get(queryEntity, context);
    ...
    public void createWithValidation() {
        NewBsonEntity entity = newValidationEntity(applicationMetadata, "validation-create");
        ...
        NewBsonEntity invalidEntity = newValidationEntity(applicationMetadata, "invld");
        try {
    ...
    public void moidfyWithValidation() {
        NewBsonEntity entity = newValidationEntity(applicationMetadata, "validation-modify");
        entity.addFieldValue("ValName", "123456789");
        ...
        IEntity newGetApp = persistenceService.get(queryEntity, context);
    ...
    public void replaceWithValidation() {
        NewBsonEntity entity = newValidationEntity(applicationMetadata, "validation-replace");
        entity.addFieldValue("ValName", "123456789");
        
        String createId = persistenceService.create(entity, context);
        NewBsonEntity queryEntity = buildQueryEntity(BRANCH_TEST, RaptorEntityGenerator.TypeEnum.ApplicationService.name(), createId);
        IEntity invalidEntity = persistenceService.get(queryEntity, context);
        ...
        invalidEntity = persistenceService.get(queryEntity, context);
        invalidEntity.addFieldValue("invalidValidationName", "invld");
        try {
            persistenceService.replace(invalidEntity, context);
            Assert.fail();
    ...
    public void manifestDiffUsingExpression() {
        NewBsonEntity newApp = newExpressEntity(applicationMetadata, "manifestDiffUsingExpression");
        ...
        NewBsonEntity queryEntity = buildQueryEntity(BRANCH_TEST, RaptorEntityGenerator.TypeEnum.ApplicationService.name(), newId);
        IEntity getApp = persistenceService.get(queryEntity, context);
    ...
    public void referenceInExpression() {
        NewBsonEntity newApp = newExpressEntity(applicationMetadata, "referenceInExpression");
    ...
    public void fieldPropertyExpression() {
        NewBsonEntity newApp = newExpressEntity(applicationMetadata, "fieldPropertyExpression");
        String newId = persistenceService.create(newApp, context);
        ...
        Assert.assertTrue(getApp.getFieldProperty("name", FieldProperty.TIMESTAMP.getName())
                .equals(getApp.getFieldValues("nameLastModifedTime").get(0)));
    }
    ...
    private NewBsonEntity newValidationEntity(MetaClass metaClass, String name) {
        NewBsonEntity entity = new NewBsonEntity(metaClass);
        entity.setBranchId(BRANCH_TEST);
