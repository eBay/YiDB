...
public class DummyEntity {
	...
	public NewBsonEntity newEntity(String metaType,String branch,String name){
		MetaClass metaClass = metaService.getMetaClass(metaType);
		CheckConditions.checkNotNull(metaClass, "Unknown meta class: " + metaType);
		NewBsonEntity inst = new NewBsonEntity(metaClass);
//        inst.setReference(true);
	...
	private Object genValue(MetaField metaField){
		...
		switch(dataType){
			...
			case STRING:
				...
				value = String.format("Dummy %s-%04d", metaField.getName(), sequence.intValue());
				break;
			case ENUM:
	...
	public NewBsonEntity newEntityWithDummyValues(String metaType,String branch,String name){
		
		MetaClass metaClass = metaService.getMetaClass(metaType);
		CheckConditions.checkNotNull(metaClass, "Unknown meta class: " + metaType);
		NewBsonEntity newEntity = newEntity(metaType,branch,name);
