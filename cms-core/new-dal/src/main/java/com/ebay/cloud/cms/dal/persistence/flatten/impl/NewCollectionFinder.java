 ...
 * 
 */
public class NewCollectionFinder extends CollectionFinder {

    private static final String COLLECTION_SUFFIX = "{0}_flatten";

    @Override
    public String getCollectionName(MetaClass metadata, DBCollectionPolicy collectionPolicy, String baseName) {
        String name = super.getCollectionName(metadata, collectionPolicy, baseName);
        return MessageFormat.format(COLLECTION_SUFFIX, name);
    }
}
