...
public class QueryParseException extends QueryException {      
    ...
    public QueryParseException(QueryErrCodeEnum errorCode, String query, Throwable t) {
        super(errorCode, "Parsing query: " + query, t);
    }
    
    public QueryParseException(QueryErrCodeEnum errorCode, String info) {
