...
public class IntegerTypeHandler extends AbstractDataTypeHandler {
    ...
    protected void validate(IEntity curEntity, Object value, MetaField metaField) throws IllegalArgumentException {
        CheckConditions.checkArgument(value instanceof Number, "%s should have input value as integer", metaField.getName());
    }
