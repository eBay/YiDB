...
public class DoubleTypeHandler extends AbstractDataTypeHandler {

    @Override
    protected void validate(IEntity curEntity, Object value, MetaField metaField) throws IllegalArgumentException {
        CheckConditions.checkArgument(value instanceof Number, "%s should have input value as double",
                metaField.getName());
    }
