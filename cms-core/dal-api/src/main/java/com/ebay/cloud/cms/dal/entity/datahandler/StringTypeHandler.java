...
public class StringTypeHandler extends AbstractDataTypeHandler {

    @Override
    protected void validate(IEntity curEntity, Object value, MetaField metaField) throws IllegalArgumentException {
        CheckConditions.checkArgument(value instanceof String, "%s should have input value as string",
                metaField.getName());
    }
