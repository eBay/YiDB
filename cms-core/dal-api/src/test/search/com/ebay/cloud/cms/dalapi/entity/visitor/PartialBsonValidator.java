...
public class PartialBsonValidator extends AbstractBsonValidator {
    ...
    public PartialBsonValidator(AbstractEntityIDHelper helper) {
        super(helper);
    }
    ...
    @Override
    protected void processId(BsonEntity parentEntity, MetaRelationship refField, BsonEntity currentEntity) {
    ...
    @Override
    protected void processVersion(BsonEntity parentEntity, MetaRelationship refField, BsonEntity currentEntity) {
    ...
    @Override
    protected void processParentVersion(BsonEntity parentEntity, MetaRelationship refField, BsonEntity currentEntity) {
        // remove version on embedded object
    ...
    @Override
    protected void processStatus(BsonEntity parentEntity, MetaRelationship refField, BsonEntity currentEntity) {
    ...
    @Override
    protected void processCreateTime(BsonEntity parentEntity, MetaRelationship refField, BsonEntity currentEntity) {
