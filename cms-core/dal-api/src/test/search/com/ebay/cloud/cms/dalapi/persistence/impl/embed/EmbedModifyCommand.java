...
public class EmbedModifyCommand extends AbstractEmbedCommand implements IPersistenceCommand {
    ...
    public EmbedModifyCommand(BsonEntity entity, AbstractEntityIDHelper helper){
        super(entity.getBranchId(), helper);
        this.entity = entity;
    }
    
    protected EmbedModifyCommand(MetaClass metaClass, String branchId, AbstractEntityIDHelper helper) {
        super(branchId, helper);
        this.entity = new BsonEntity(metaClass);
    }
