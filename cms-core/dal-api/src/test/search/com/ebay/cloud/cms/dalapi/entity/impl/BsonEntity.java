...
import com.ebay.cloud.cms.dalapi.entity.impl.bson.datahandler.BsonDataTypeHandlerFactory;
...
public class BsonEntity extends AbstractEntity {
    ...
    // ignoring null
    private void addReadValue(DataTypeEnum dataType, List<Object> result, Object value) {
        if (value != null) {
            result.add(value);
        }
    }
    ...
    private boolean addWriteValue(BasicDBObject fieldBsonObject, String dbValName, DataTypeEnum dataType, Object bsonValue) {
        boolean added = false;
        if (DataTypeEnum.STRING.equals(dataType) || bsonValue != null) {
            fieldBsonObject.put(dbValName, bsonValue);
            added = true;
        }
        return added;
    }
    private boolean addWriteValue(DataTypeEnum dataType, Object bsonValue, List<Object> bsonList) {
        boolean added = false;
        if (DataTypeEnum.STRING.equals(dataType) || bsonValue != null) {
