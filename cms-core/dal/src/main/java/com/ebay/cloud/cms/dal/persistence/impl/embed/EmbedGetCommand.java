...
public class EmbedGetCommand extends AbstractEmbedCommand implements IRetrievalCommand {
	...
	public EmbedGetCommand(String branchId, String entityId, MetaClass entityType, AbstractEntityIDHelper helper){
	...
	public void execute(PersistenceContext context) {
        ...
        DBObject embedObject = EmbedDBObjectFilter.filter(entityId, rootObject, rootMetaClass, context.getQueryFields(), helper);
        if (embedObject != null) {
