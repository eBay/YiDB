...
public class RootGetCommand implements IRetrievalCommand {
    ...
    public static DBObject findDBObject(String entityId, String branchId, PersistenceContext context, MetaClass metadata, 
            Collection<String> fields, boolean needActive) {
