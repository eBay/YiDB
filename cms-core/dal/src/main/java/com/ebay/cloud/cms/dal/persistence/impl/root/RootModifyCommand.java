...
public class RootModifyCommand implements IPersistenceCommand {
	...
	public RootModifyCommand(BsonEntity entity){
		this.entity = entity;
	...
	public void execute(PersistenceContext context) {
		...
		if(result.getN()==0){
		    ...
		    if (getResult == null) {
		        throw new CmsDalException(DalErrCodeEnum.ENTITY_NOT_FOUND, "Can't find entity: oid=" + entity.getId());
		    } 
		    ...
		    throw new CmsDalException(DalErrCodeEnum.VERSION_CONFLICT, 
                  "current version is " + currentVersion + ", but version in modify body is " + version + "! entity is " + entity.toString());
		}
	}
