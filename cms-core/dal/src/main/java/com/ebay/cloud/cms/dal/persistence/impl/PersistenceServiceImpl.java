...
import com.ebay.cloud.cms.dal.entity.visitor.BsonPopulator;
import com.ebay.cloud.cms.dal.entity.visitor.FullBsonValidator;
import com.ebay.cloud.cms.dal.entity.visitor.PartialBsonValidator;
...
import com.ebay.cloud.cms.dal.persistence.impl.embed.EmbedCreateCommand;
import com.ebay.cloud.cms.dal.persistence.impl.embed.EmbedDeleteCommand;
import com.ebay.cloud.cms.dal.persistence.impl.embed.EmbedFieldDeleteCommand;
import com.ebay.cloud.cms.dal.persistence.impl.embed.EmbedFieldModifyCommand;
import com.ebay.cloud.cms.dal.persistence.impl.embed.EmbedGetCommand;
import com.ebay.cloud.cms.dal.persistence.impl.embed.EmbedModifyCommand;
import com.ebay.cloud.cms.dal.persistence.impl.embed.EmbedReplaceCommand;
import com.ebay.cloud.cms.dal.persistence.impl.root.RootCountCommand;
import com.ebay.cloud.cms.dal.persistence.impl.root.RootCreateCommand;
import com.ebay.cloud.cms.dal.persistence.impl.root.RootDeleteCommand;
import com.ebay.cloud.cms.dal.persistence.impl.root.RootFieldDeleteCommand;
import com.ebay.cloud.cms.dal.persistence.impl.root.RootFieldModifyCommand;
import com.ebay.cloud.cms.dal.persistence.impl.root.RootGetCommand;
import com.ebay.cloud.cms.dal.persistence.impl.root.RootMarkDeletedCommand;
import com.ebay.cloud.cms.dal.persistence.impl.root.RootModifyCommand;
import com.ebay.cloud.cms.dal.persistence.impl.root.RootReplaceCommand;
...
public class PersistenceServiceImpl implements IPersistenceService {
	...
	public void modifyField(IEntity bsonEntity, String fieldName, PersistenceContext context) {
        ...
        // Doesn't calculate the expression since expect only delta to be added.
		IPersistenceCommand modifyCommand = null;
		MetaClass meta = entity.getMetaClass();
		if (meta.isEmbed()) {
