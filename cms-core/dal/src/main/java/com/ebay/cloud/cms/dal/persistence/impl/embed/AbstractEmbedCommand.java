...
public abstract class AbstractEmbedCommand {
    ...
    protected DBObject buildGetQuery(BitSet arrayBits, String embedId, MetaClass rootMetaClass, PersistenceContext context) {
        ...
        return RootGetCommand.addContextCriteria(rootMetaClass, context, queryObject);
    }
