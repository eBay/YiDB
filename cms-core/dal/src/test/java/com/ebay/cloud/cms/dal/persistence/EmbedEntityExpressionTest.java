...
public class EmbedEntityExpressionTest extends CMSMongoTest {
    ...
    public void createWithExpression() {
        BsonEntity dep1      = newExpressEntity(depMetadata, "dep1");
        BsonEntity team11    = newExpressEntity(teamMetadata, "team11");
        BsonEntity person111 = newPersonEntity(personMetadata, "person111", "25");
        team11.addFieldValue("person", person111);
        
        BsonEntity team12    = newExpressEntity(teamMetadata, "team12");
        BsonEntity person121 = newPersonEntity(personMetadata, "person121", "28");
        BsonEntity person122 = newPersonEntity(personMetadata, "person122", "52");
        ...
        BsonEntity queryEntity = buildQueryEntity(BRANCH_TEST, RaptorEntityGenerator.TypeEnum.Dep.name(), createId);
        BsonEntity getDep = (BsonEntity)persistenceService.get(queryEntity, context);
        verifyDep(getDep);        
    }
    ...
    public void moidfyWithExpression() {
        BsonEntity dep2      = newExpressEntity(depMetadata, "dep2");
        BsonEntity team21    = newExpressEntity(teamMetadata, "team21");
        BsonEntity person211 = newPersonEntity(personMetadata, "person211", "25");
        ...
        BsonEntity person212 = newPersonEntity(personMetadata, "person212", "28");
        ...
        getDep = (BsonEntity)persistenceService.get(queryEntity, context);
        verifyDep(getDep);
    }
    ...
    public void moidfyWithValidation() {
        BsonEntity dep2      = newExpressEntity(depMetadata, "dep2");
        BsonEntity team21    = newExpressEntity(teamMetadata, "team21");
        BsonEntity person211 = newPersonEntity(personMetadata, "person211", "52");
    ...
    public void replaceWithExpression() {
        ...
        BsonEntity person112 = newPersonEntity(personMetadata, "person112", "60");
    ...
    public void replaceWithValidation() {
        BsonEntity dep1      = newExpressEntity(depMetadata, "dep1");
        BsonEntity team11    = newExpressEntity(teamMetadata, "team11");
        BsonEntity person111 = newPersonEntity(personMetadata, "person111", "52");
        person111.addFieldValue("oldPerson", "yes");
        team11.addFieldValue("person", person111);
        dep1.addFieldValue("team", team11);
        ...
        IEntity team = teams.get(0);
        team.removeField("person");
        BsonEntity person112 = newPersonEntity(personMetadata, "person112", "25");
    ...
    public void referenceInExpression() {
        ...
        BsonEntity queryEntity = buildQueryEntity(BRANCH_TEST, RaptorEntityGenerator.TypeEnum.Dep.name(), newId);
        BsonEntity getDep = (BsonEntity)persistenceService.get(queryEntity, context);
    ...
    private BsonEntity newPersonEntity(MetaClass metaClass, String name, String age) {
        BsonEntity entity = new BsonEntity(metaClass);
        entity.setBranchId(BRANCH_TEST);
