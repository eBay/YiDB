...
//    }
    ...
    public void testAdd() {
        BsonEntity newEntity = new BsonEntity(serviceInstanceMetadata);
    ...
    public void testGetFieldValuesOne() {
        ...
        BsonEntity bsonEntity = new BsonEntity(serviceInstanceMetadata, given);
        ...
        // not present
        given.put(nameField.getDbName(), null);
        ...
        nameValue.put(MetaField.VALUE_KEY, null);
        given.put(nameField.getDbName(), nameValue);
        Assert.assertTrue(bsonEntity.hasField(nameField.getName()));
        Assert.assertNotNull(bsonEntity.getFieldValues(nameField.getName()));
        Assert.assertTrue(bsonEntity.getFieldValues(nameField.getName()).isEmpty());
        ...
        nameValue.put(MetaField.VALUE_KEY, serviceName);
        Assert.assertTrue(bsonEntity.hasField(nameField.getName()));
        Assert.assertNotNull(bsonEntity.getFieldValues(nameField.getName()));
    ...
    public void testGetFieldValuesMany() {
        ...
        // 
        BasicDBObject activeManifestValue = new BasicDBObject();
        activeManifestValue.put(MetaField.VALUE_KEY, null);
        given.put(activeManifestRefField.getDbName(), activeManifestValue);
        ...
        activeManifestValue.put(MetaField.VALUE_KEY, manifestValuesList);
        Assert.assertTrue(bsonEntity.hasField(activeManifestRefField.getName()));
        Assert.assertNotNull(bsonEntity.getFieldValues(activeManifestRefField.getName()));
        Assert.assertTrue(bsonEntity.getFieldValues(activeManifestRefField.getName()).isEmpty());
        ...
        activeManifestValue.put(MetaField.VALUE_KEY, singleValue);
        Assert.assertTrue(bsonEntity.hasField(activeManifestRefField.getName()));
        Assert.assertNotNull(bsonEntity.getFieldValues(activeManifestRefField.getName()));
        Assert.assertFalse(bsonEntity.getFieldValues(activeManifestRefField.getName()).isEmpty());
        Assert.assertTrue(bsonEntity.getFieldValues(activeManifestRefField.getName()).size() == 1);
    ...
    public void testAddFieldValueOne() {
        ...
        Assert.assertTrue(bsonEntity.getFieldValues(fieldName).size() == 0);
    ...
    public void testGetFieldValuesOne_nullReference() {
        ...
        given.put(nameField.getValueDbName(), dbo);
        runsOnComputes = bsonEntity.getFieldValues(nameField.getName());
        Assert.assertNotNull(runsOnComputes);
        Assert.assertTrue(runsOnComputes.isEmpty());
    }
    ...
    public void testGetFieldValuesMany_nullReference() {
        ...
        BasicDBObject given = new BasicDBObject();
        BsonEntity bsonEntity = new BsonEntity(appServiceMetadata, given);
        ...
        BasicDBObject dbo = new BasicDBObject();
        dbo.put(MetaField.VALUE_KEY, null);
        given.put(nameField.getDbName(), dbo);
        runsOnComputes = bsonEntity.getFieldValues(nameField.getName());
        Assert.assertNotNull(runsOnComputes);
        Assert.assertTrue(runsOnComputes.isEmpty());
        ...
        dbo.put(MetaField.VALUE_KEY, services);
        services.add(dbo);
        services.add(null);
        given.put(nameField.getDbName(), dbo);
        try {
    ...
    public void testSetFieldValuesOne_nullReference() {
        ...
        computes = new ArrayList<BsonEntity>();
        computes.add(null);
        try {
    ...
    public void testSetFieldValuesMany_nullReference() {
        ...
        List<BsonEntity> serviceEntities = new ArrayList<BsonEntity>();
        serviceEntities.add(new BsonEntity(serviceInstanceMetadata));
    ...
    public void testIntegerLongGetInvalidValue() {
        BasicDBObject given = new BasicDBObject();
        BsonEntity bsonEntity = new BsonEntity(environmentMeta, given);
        // long
    ...
    public void testReferenceGetInvalidValue() {
        BasicDBObject given = new BasicDBObject();
        BsonEntity appEntity = new BsonEntity(appServiceMetadata, given);
    ...
    public void testAddInvalidValue() {
        BsonEntity bsonEntity = new BsonEntity(environmentMeta);
        String longFieldName = "numServices";
        String intFieldName = "numService";
        // case 0 : for long
        try {
    ...
    public void testAddBooleanInvalidValue() {
        BsonEntity bsonEntity = new BsonEntity(serviceInstanceMetadata);
        try {
    ...
    public void testSetFieldValue_asEmpty() {
        ...
        DBObject dbObject = (DBObject) newEntity.getNode().get(field.getDbName());
        Assert.assertNotNull(dbObject);
        Object valueObject = dbObject.get(MetaField.VALUE_KEY);
        Assert.assertNotNull(valueObject);
        Assert.assertEquals(Collections.emptyList(), valueObject);
    }
    
    // unit test case added from the production case: found a lot entities with "opState" value as null, which make 
    // query throw "java.lang.IllegalArgumentException: Invalid enum value maintenance in MetaAttribute opState"
    // read null from database, just pass through
    @Test
    public void testUpdateBsonNullEnumField() {
        // case 0 : set with an enum field as
        // null to update the entity
        BsonEntity updateBson = new BsonEntity(environmentMeta);
        String actionStatus = "actionStatus";
        try {
            updateBson.addFieldValue(actionStatus, null);
            Assert.fail();
        } catch (IllegalArgumentException e) {
            // expected
        }
